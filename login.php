				...
				<div class="card-body">
					<form method="post" id="patient_login_form">
						<div class="form-group">
							<label>Addresse email du patient</label>
						...
						<div class="form-group text-center">
							...
							<input type="submit" name="patient_login_button" id="patient_login_button" class="btn btn-primary" value="Se connecter" />
						</div>
		...
		if($('#patient_login_form').parsley().isValid())
		{
			$.ajax({
				...
				success:function(data)
				{
					...
					{
						window.location.href="tbl_bord.php";
					}
				}
			});
		}
